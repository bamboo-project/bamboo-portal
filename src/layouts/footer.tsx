...
export default function Footer(props) {
  return (
    <div className={classnames(styles.wrap, 'p-14 bg-black')}>
      <div className="flex flex-col md:flex-row container">
        <div className="w-full lg:w-6/12">
          <div className="flex flex-col justify-center items-center pr-24">
            ...
            />
            <div className="text-center text-white hidden md:block md:mt-5 font-game">New STYLE to explore the Web3.0 social network </div>
          </div>
        </div>
